    ...
    render() {
        ...
        return (
            <div className={classes.container}>
                <div className={classes.tel_box}>
                    <div className={classes.select_box} onChange={this.countryFlagHandler}>
                        <img src={this.state.flagImg} alt="country-flag" id="img" className={classes.flag_img} />
                        <select
                            id="country"
                        ...
                        <span className="result">
                            +{this.state.countryCodeValue} {/* This sould be inside inside input like, the component of step 2, so, have to export the Cody country value to InputPhone.jsx */}
                        </span>
                    </div>
                </div>
            </div>
